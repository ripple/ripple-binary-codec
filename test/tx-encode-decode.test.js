...
describe('encoding and decoding tx_json', function () {
  ...
  test('throws when Fee is a number instead of a string-encoded integer', function () {
    const my_tx = { ...tx_json, Amount: 1234.56 }
    expect(() => {
      encode(my_tx)
    }).toThrow()
  })
