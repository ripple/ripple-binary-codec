...
const {encodeForSigning, encodeForSigningClaim, encodeForMultisigning} = require('../src');
...
describe('Signing data', function() {
  ...
  it.only('can create claim blob', function() {
    const channel = '43904CBFCDCEC530B4037871F86EE90BF799DF8D2E0EA564BC8A3F332E4F5FB1'
    const amount = '1000'
